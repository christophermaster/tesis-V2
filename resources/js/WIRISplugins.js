(function() {
    ...
    ValueType.TClass = function(c) { var $x = ["TClass", 6, c];
        $x.__enum__ = ValueType;
        $x.toString = $estr; return $x; }
    ValueType.TEnum = function(e) { var $x = ["TEnum", 7, e];
        $x.__enum__ = ValueType;
        $x.toString = $estr; return $x; }
    ...
    com.wiris.js.JsPluginViewer.prototype = {
        ...
        isPerformanceEnabled: function() {
            ...
            else return haxe.Json.parse(data).result.wirispluginperformance == "true" ? true : false;
        },
        ...
        callShowimage: function(container, mml, img, asynchronously, callbackFunc) {
            ...
            while (_g1 < _g2) {
                ...
                if (HxOverrides.cca(mml, i) > 128) mmlEntities += "&#" + HxOverrides.cca(mml, i) + ";";
            ...
            if (new com.wiris.js.JsBrowser().isIE()) data = "?formula=" + md5 + "&lang=" + this.lang + "&useragent=IE";
            ...
            var onloadFunc = function(e) {
                var getResultFunc = function(e1) {
                    ...
                    if (_g.wiriseditormathmlattribute == null) {
                        ...
                        if (wirisEditorMathmlAttributeCall.status != "ok") _g.wiriseditormathmlattribute = "data-mathml";
                        else _g.wiriseditormathmlattribute = wirisEditorMathmlAttributeCall.result.wiriseditormathmlattribute;
                    }
                ...
                if (haxe.Json.parse(con.responseText).status == "warning") {
                    ...
                    if (new com.wiris.js.JsBrowser().isIE()) data = "centerbaseline=false&mml=" + StringTools.urlEncode(e.target.wiris.mml) + "&useragent=IE";
                    else data = "centerbaseline=false&mml=" + StringTools.urlEncode(e.target.wiris.mml);
                    var newDynamic = {};
                    con.wiris = newDynamic;
                    con.wiris.callbackFunc = callbackFunc;
        ...
        processMathML: function(mml, container, asynchronously, callbackFunc) {
            ...
            if (this.mode == com.wiris.js.JsPluginViewer.USE_CREATE_IMAGE && this.performanceenabled) this.callShowimage(container, mml, img, asynchronously, callbackFunc);
            else if (this.mode == com.wiris.js.JsPluginViewer.USE_CREATE_IMAGE && !this.performanceenabled) this.callCreateImage(mml, img);
            else img.src = this.baseURL + this.localpath + "/showimage" + this.extension + "?mml=" + StringTools.urlEncode(mml);
        ...
        getMathML_IE7: function(mathNode0) {
            ...
            while (mathNode != null && mathNode.nodeName != "/MATH") {
                if (mathNode.nodeType == 3) mathml += mathNode.nodeValue;
                    ...
                    if (nodeName.charAt(0) == "/") mathml += "</" + HxOverrides.substr(nodeName, 1, null) + ">";
                    else {
                        mathml += "<" + nodeName;
        ...
        if (navigator.msPointerEnabled && com.wiris.system.JsDOMUtils.ieTouchEvents.exists(eventName)) {
            ...
            return com.wiris.system.JsDOMUtils.addEventListenerImpl(element, eventName, function(e) {
                if (e.pointerType == "touch") {
                    if (eventName == "MSPointerUp") com.wiris.system.JsDOMUtils.internetExplorerPointers.remove("" + e.pointerId);
                    else com.wiris.system.JsDOMUtils.internetExplorerPointers.set("" + e.pointerId, e);
                    e.touches = new Array();
        ...
        if (eventName == "dblclick") {
            ...
            descriptor.subDescriptors.push(com.wiris.system.JsDOMUtils.addEventListenerImpl(element, "touchend", function(e) {
                if (touching) {
                    ...
                    if (firstClickTimestamp == null || currentTimestamp > firstClickTimestamp + 500) firstClickTimestamp = currentTimestamp;
                    else {
    ...
    com.wiris.system.JsDOMUtils.removeEventListener = function(descriptor) {
        if (com.wiris.system.JsDOMUtils.browser.isIE() && descriptor.element.detachEvent) descriptor.element.detachEvent("on" + Std.string(descriptor.eventName), descriptor.handler);
        else descriptor.element.removeEventListener(descriptor.eventName, descriptor.handler, descriptor.useCapture);
    ...
    com.wiris.system.JsDOMUtils.addClass = function(element, className) {
        ...
        else if (!com.wiris.system.JsDOMUtils.hasClass(element, className)) element.className += " " + className;
    }
    ...
    com.wiris.system.JsDOMUtils.toggleClass = function(element, className) {
        if (com.wiris.system.JsDOMUtils.hasClass(element, className)) com.wiris.system.JsDOMUtils.removeClass(element, className);
    ...
    com.wiris.system.JsDOMUtils.getSelectionBounds = function(element) {
        ...
        if (range && range.parentElement() == element) {
            ...
            if (textInputRange.compareEndPoints("StartToEnd", endRange) > -1) bounds[0] = bounds[1] = length;
            else {
                bounds[0] = -textInputRange.moveStart("character", -length);
                bounds[0] += normalizedValue.slice(0, bounds[0]).split("\n").length - 1;
                if (textInputRange.compareEndPoints("EndToEnd", endRange) > -1) bounds[1] = length;
                else {
    ...
    com.wiris.system.JsDOMUtils.createCSSRules = function(selector, rules) {
        ...
        if (style.sheet != null && style.sheet.insertRule != null) style.sheet.insertRule(selector + "{" + rules + "}", 0);
        else if (style.styleSheet != null) style.styleSheet.addRule(selector, rules);
    ...
    haxe.io.Error.Custom = function(e) { var $x = ["Custom", 3, e];
    ...
    function $bind(o, m) { var f = function() { return f.method.apply(f.scope, arguments); };
        f.scope = o;
        f.method = m; return f; };
